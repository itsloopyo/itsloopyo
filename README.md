...
I'm on a mission to bring immersive head tracking to the games we love, make high-quality head tracking free for everybody, and make it all effortless to use.
...
- **Released** mods have been pretty well tested and probably won't have game breaking bugs.
- **Beta** mods are in a mature state, but haven't been thoroughly tested and/or have known issues
...
| Subnautica 2 | Released | [GitHub](https://github.com/itsloopyo/subnautica-2-headtracking) · [NexusMods](https://www.nexusmods.com/subnautica2/mods/250) | v0.6.2 (2026-09-08) |
