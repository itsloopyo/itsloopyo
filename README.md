...
I'm on a mission to make high-quality head tracking free for everybody, mod it into the games we love and ensure it's all effortless to use.
...
That's it! Download a tracker and Lopari, run Lopari, and it will detect all the games
below and let you run them in one click (or take you to a download for betas)
...
- **Beta** mods are feature complete, but haven't been thoroughly tested and/or have known issues
...
| Outer Wilds | Released | Steam | [GitHub](https://github.com/itsloopyo/outer-wilds-headtracking) | v1.3.0 (2026-08-20) |
